...
import { TokenData, RemoteAuthConfig } from '../types';
import { Logger } from '../utils/logger';

/**
 * Remote storage authentication strategy
 */
export class RemoteAuthStrategy extends AuthStrategy {
  private onUpload: (data: TokenData) => Promise<void>;
  private onDownload: () => Promise<TokenData | null>;

  constructor(config: RemoteAuthConfig, logger?: Logger) {
